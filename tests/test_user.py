...
def new_user2():
    user2 = User(
        name="Sean Walker",
        username="swalker",
        email="swalker22@outlook.com",
        password="seaniscool32",
    )
    return user2
...
def new_expense():
    expense1 = Expense(
        name="McDonalds", date="2022-05-03", category="Food", amount=5.23
    )
    return expense1
...
def test_name_invalid():
    ...
    with pytest.raises(TypeError):
        User(
            name=12354, email="test@test.com", username="hello", password="password123"
        )
...
def test_email_invalid():
    ...
    with pytest.raises(TypeError):
        User(name="john smith", email=123123, username="hello", password="password453")
